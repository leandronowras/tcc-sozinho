...
import TestTUtil from '../_util/testUtil.js'
...
describe('#Routes test suite', () => {
  ...
  const request = TestTUtil.generateReadableStream(['some file bytes'])
  const response = TestTUtil.generateWritadableStream(() => {})
    const defaultParams = {
    ...
    describe('#post', () => {
      test('it should validate post route workflow', async () => {
        ...
        jest.spyOn(
          ...
          const writable = TestTUtil.generateWritadableStream(() => {})
